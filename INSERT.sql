...
VALUES
    ...
    (2365, 2, 8906, "g", 250, 150, 250, '1993-03-15'),
    (3463, 3, 1938, "n", 0, 250, 0, '1995-07-31'),
    (7233, 4, 3298, "g", 250, 300, 150, '1997-12-19'),
    (5753, 5, 1938, "g", 750, 250, 350, '2000-05-14'),
    (2947, 6, 3849, "p", 250, 150, 150, '2003-09-07'),
    (3733, 7, 6471, "n", 0, 150, 0, '2007-03-04'),
    (9562, 8, 5127, "n", 0, 250, 75, '2009-09-15'),
    (7652, 9, 3298, "g", 500, 300, 500, '2013-04-15'),
    (9237, 10, 5723, "p", 250, 250, 0, '2015-08-15'), 
    (4221, 11, 6471, "n", 0, 150, 150, '2017-09-15');
...
-- d: disproved
INSERT INTO appeal
    (case_id, attempt_num, filing_date, appeal_hearing_date, result_status)
VALUES
    (1, 1, '1990-10-15', '1990-10-19', "a"),
    (2, 1, '1993-03-15', '1993-03-23', "d"),
    (2, 2, '1993-04-15', '1993-04-27', "d"),
    (2, 3, '1993-05-15', '1993-05-19', "p"),
    (4, 1, '1997-12-19', '1997-12-22', "d"),
    (4, 2, '1998-01-19', '1998-01-21', "a"),
    (9, 1, '2013-05-15', '2013-06-15', "d"),
    (9, 2, '2013-06-15', '2013-06-30', "a"),
    (10, 1, '2015-08-15', '2015-08-23', "p"),
    (5, 1, '2000-05-14', '2000-05-17', "a");
