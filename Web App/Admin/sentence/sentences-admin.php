        ...
        <center>
            <div style="width:1000px;">
                <div  class="edit-search" style ="margin: 10px auto; display:inline-block;">
                    <button style="width:150px;"> <a style="color:inherit;font-size: inherit;line-height: inherit;" href="search-sentences-admin.php">Search Table</a></button>
                </div>
                <div class="edit-search" style ="margin: 10px auto; display:inline-block;">
                    <button style="width:150px;"> <a style="color:inherit;font-size: inherit;line-height: inherit;" href="edit-sentences-admin.php">Update Table</a></button>
                </div>
                <div class="edit-search" style ="margin: 10px auto; display:inline-block;">
                    <button style="width:150px;"><a style="color:inherit;font-size: inherit;line-height: inherit;" href="add-sentences-admin.php">Add Record</a></button>
                </div>
                <div class="edit-search" style ="margin: 10px auto; display:inline-block;">
                    <button style="width:150px;"><a style="color:inherit;font-size: inherit;line-height: inherit;" href="delete-sentences-admin.php">Delete Record</a></button>
                </div>
            </div>
